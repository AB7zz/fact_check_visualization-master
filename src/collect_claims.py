...
def collect_from_db():
    conn = psycopg2.connect(database="d59gh4qg7hjsc5", user = "u6hioa2fipo9p8", password = "pb2ut17ergeevk18praoa8icbdm", host = "ec2-35-169-140-59.compute-1.amazonaws.com", port = "5432")
